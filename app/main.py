...
def estimate_base_top_climb(openmeteo_json):
    ...
    T1000 = (hourly.get("temperature_1000hPa") or [16.0])[0]
    T850  = (hourly.get("temperature_850hPa")  or [7.0])[0]
    lapse = (T1000 - T850) / ((1460-110)/1000)  # zelo grob K/km
...
def run_for_today():
    # center Vzhodne Štajerske
    lat, lon = 46.56, 15.65

    data = wind_temp_profile(lat, lon)
    base, top, climb = estimate_base_top_climb(data)
    wdir, wspd = pick_wind(data)
