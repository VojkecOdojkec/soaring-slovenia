...
def _arrow_dxdy(dir_from_deg, L=0.9):
    # meteorološka smer = "OD koder piha"; za puščico "KAM piha" dodamo 180°
    theta = math.radians((dir_from_deg + 180) % 360)
...
def save_minichart(path, base_m, top_m, climb_ms, wind_text=None, wind_profile=None, surface=None):
    """
    wind_profile: [(višina_m, dir_deg, spd_ms), ...]  npr. [(800,140,4.2),(1500,170,6.0),(3000,210,8.0)]
    surface: (dir_deg, spd_ms) za kompas (neobvezno)
    """
